      ...
      <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col border border-gray-200/50">
        ...
        <div className="p-4 md:p-6 overflow-y-auto flex-1 custom-scrollbar min-h-0">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-800 bg-white backdrop-blur-md rounded-xl p-4 border border-gray-200 shadow-lg">
              {assignedUserName}
            </p>
          </div>
        ...
        {/* Footer */}
        <div className="border-t border-gray-200 bg-white/95 backdrop-blur-xl px-4 md:px-6 py-3 md:py-4 flex justify-between items-center gap-2 flex-shrink-0 flex-wrap">
          {/* Delete Button - Left */}
          <div>
            {!showDeleteConfirm ? (
              <button
